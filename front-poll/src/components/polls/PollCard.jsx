      ...
      <div className="relative h-full flex flex-col p-5 rounded-xl">
        ...
        <div className="relative z-10 mt-auto">
          ...
          <button
            ...
            className="relative inline-flex items-center justify-center cursor-pointer w-full px-4 py-2.5 overflow-hidden font-medium transition-all duration-300 ease-out rounded-lg group bg-gradient-to-r from-purple-600 to-blue-500 hover:from-purple-500 hover:to-blue-400"
          >
